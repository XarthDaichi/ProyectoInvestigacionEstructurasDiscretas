...
%----------------------------------------------------------------------------------------------------------------------------------------------------------------------
\section*{\textit{String Matching}}% -seccion de string matching con ejemplos ilustrativos propios
\phantomsection
...
\subsection*{Fuerza Bruta (Naive Algorithm)}
\addcontentsline{toc}{subsection}{Fuerza bruta (Naive Algorithm)}
